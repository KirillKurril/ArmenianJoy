...
@dso_cache = dso_local local_unnamed_addr global [762 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 170729522, ; hash 0xa2d2032, from name: aot-Backgammon.UI
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 606344487, ; hash 0x24241527, from name: Backgammon.Client
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 665725320, ; hash 0x27ae2988, from name: Backgammon.UI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Backgammon.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 105
	...
	%struct.DSOCacheEntry {
		i64 1493468503, ; hash 0x59048557, from name: aot-Backgammon.Client.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Backgammon.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 259
	...
	%struct.DSOCacheEntry {
		i64 1499605563, ; hash 0x59622a3b, from name: aot-Entities.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1536968337, ; hash 0x5b9c4691, from name: Entities.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 267
	...
	%struct.DSOCacheEntry {
		i64 2083430522, ; hash 0x7c2ea07a, from name: libaot-Entities.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 362
	...
	%struct.DSOCacheEntry {
		i64 2317345902, ; hash 0x8a1fe46e, from name: Backgammon.Client.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Backgammon.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
	...
	%struct.DSOCacheEntry {
		i64 2413174773, ; hash 0x8fd61ff5, from name: libaot-Backgammon.UI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Backgammon.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 426
	...
	%struct.DSOCacheEntry {
		i64 2629983731, ; hash 0x9cc25df3, from name: Entities
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 468
	...
	%struct.DSOCacheEntry {
		i64 2804952253, ; hash 0xa7302cbd, from name: libaot-Backgammon.Client
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Backgammon.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 505
	...
	%struct.DSOCacheEntry {
		i64 2935320062, ; hash 0xaef56dfe, from name: aot-Backgammon.Client
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Backgammon.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 530
	...
	%struct.DSOCacheEntry {
		i64 2958190276, ; hash 0xb05266c4, from name: Backgammon.UI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Backgammon.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 538
	...
	%struct.DSOCacheEntry {
		i64 3487175483, ; hash 0xcfda133b, from name: libaot-Backgammon.UI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Backgammon.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 623
	...
	%struct.DSOCacheEntry {
		i64 3586457778, ; hash 0xd5c500b2, from name: aot-Backgammon.UI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Backgammon.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 641
	...
	%struct.DSOCacheEntry {
		i64 3753363748, ; hash 0xdfb7c924, from name: aot-Entities
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 669
	...
	%struct.DSOCacheEntry {
		i64 3966739666, ; hash 0xec6fa4d2, from name: libaot-Entities
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 706
	...
	%struct.DSOCacheEntry {
		i64 4154974539, ; hash 0xf7a7e14b, from name: libaot-Backgammon.Client.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Backgammon.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 737
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [157 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
